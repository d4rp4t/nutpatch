...
// Forward declaration of `NativeBlindedMessage` to properly resolve imports.
namespace margelo::nitro::nutpatch { struct NativeBlindedMessage; }

#include "NativeBlindedMessage.hpp"
#include <string>

namespace margelo::nitro::nutpatch {

  /**
   * A struct which can be represented as a JavaScript object (NativeOutputData).
   */
  struct NativeOutputData final {
  public:
...
namespace margelo::nitro {
  ...
  // C++ NativeOutputData <> JS NativeOutputData (object)
  template <>
  struct JSIConverter<margelo::nitro::nutpatch::NativeOutputData> final {
    static inline margelo::nitro::nutpatch::NativeOutputData fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
